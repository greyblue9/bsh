...
public class JavaCharStream {
  ...
  public char readChar() throws IOException {
    if(this.inBuf > 0) {
      ...
      char c;
      if((this.buffer[this.bufpos] = c = this.ReadByte()) != 92) {
  ...
  public void adjustBeginLineColumn(int newLine, int newCol) {
    ...
    for(columnDiff = 0; i < len; ++i) {
      ...
      ++start;
      int var10;
      if(var10000 != this.bufline[var10 = start % this.bufsize]) {
        break;
      }

      this.bufline[j] = newLine;
      int var11 = columnDiff + this.bufcolumn[var10] - this.bufcolumn[j];
