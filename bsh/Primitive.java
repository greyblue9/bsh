...
import java.util.*;
import org.d6r.NotImplementedException;
...
public final class Primitive implements ParserConstants, java.io.Serializable {
  ...
  */
                     ...
                     Collection<Object>
  {
    ...
    static final Collection<Object> m_Collection = new
      AbstractCollectionDecorator<Object>() {
       @Override protected Collection<Object> decorated() {
          return Collections.emptyList();
        }
      };
      
    
    private Special(String display, Object val) {
    ...
    public String toString() {
      return String.format("\u001b[1;31m<{ %s }>\u001b[0m", display);
    }
    ...
    @Override public boolean add(Object a) { return m_Collection.add(a); }
    @Override public boolean addAll(Collection<? extends Object> a) { 
      return m_Collection.addAll(a); }
    @Override public void clear() { m_Collection.clear(); }
    @Override public boolean contains(Object a) { 
      return m_Collection.contains(a); }
    @Override public boolean containsAll(Collection<?> a) { 
      return m_Collection.containsAll(a); }

    @Override public boolean isEmpty() { return m_Collection.isEmpty(); }
    @Override public Iterator<Object> iterator() { 
      return m_Collection.iterator();
    }
    @Override public boolean remove(Object a) { 
      return m_Collection.remove(a); }
    @Override public boolean removeAll(Collection<?> a) { 
      return m_Collection.removeAll(a); }
    @Override public boolean retainAll(Collection<?> a) { 
      return m_Collection.retainAll(a);
    }
    @Override public int size() { return m_Collection.size(); }
    @Override public Object[] toArray() { return m_Collection.toArray(); }
  ...
  */
  ...
  public Primitive(Object value) {
    if (value == null) throw new InterpreterError("Use Primitve.NULL instead of Primitive(null)");
    if (value != Special.NULL_VALUE && value != Special.VOID_TYPE && !isWrapperType(value.getClass())) throw new InterpreterError("Not a wrapper type: " + value);
    this.value = value;
  }
  ...
  */
  ...
  public String toString() {
    if (value == Special.NULL_VALUE) return "null"; else if (value == Special.VOID_TYPE) return "void"; else return value.toString();
  }
  ...
  */
  public static Object binaryOperation(Object obj1, Object obj2, int kind) throws UtilEvalError {
    ...
    if ((lhsOrgType == Primitive.class && rhsOrgType == Primitive.class) || result instanceof Boolean) return new Primitive(result); else return result;
  }
    ...
    switch((kind)) {
      ...
      default: 
        throw new NotImplementedException(
          "default: block in switch statement, in class bsh.Primitive"
        );
    }
  }
  ...
  */
  static Object promoteToInteger(Object wrapper) {
    if (wrapper instanceof Character) return new Integer(((Character) wrapper).charValue()); else if ((wrapper instanceof Byte) || (wrapper instanceof Short)) return new Integer(((Number) wrapper).intValue());
    return wrapper;
  }
  ...
  */
  static Object[] promotePrimitives(Object lhs, Object rhs) {
    ...
    if ((lhs instanceof Number) && (rhs instanceof Number)) {
      ...
      if ((b = (lnum instanceof Double)) || (rnum instanceof Double)) {
        if (b) rhs = new Double(rnum.doubleValue()); else lhs = new Double(lnum.doubleValue());
        ...
        if (b) rhs = new Long(rnum.longValue()); else lhs = new Long(lnum.longValue());
      }
    }
  ...
  public static Primitive unaryOperation(Primitive val, int kind) throws UtilEvalError {
    ...
    if (operand instanceof Boolean) return new Primitive(booleanUnaryOperation((Boolean) operand, kind)); else if (operand instanceof Integer) {
  ...
  public int intValue() throws UtilEvalError {
    if (value instanceof Number) return ((Number) value).intValue(); else throw new UtilEvalError("Primitive not a number");
  }

  public boolean booleanValue() throws UtilEvalError {
    if (value instanceof Boolean) return ((Boolean) value).booleanValue(); else throw new UtilEvalError("Primitive not a boolean");
  }
  ...
  */
  ...
  public Number numberValue() throws UtilEvalError {
    ...
    if (value instanceof Number) return (Number) value; else throw new UtilEvalError("Primitive not a number");
  }
  ...
  */
  public boolean equals(Object obj) {
    if (obj instanceof Primitive) return ((Primitive) obj).value.equals(this.value); else return false;
  }
  ...
  */
  public static Object unwrap(Object obj) {
    ...
    // unwrap primitives
    if (obj instanceof Primitive) return ((Primitive) obj).getValue(); else return obj;
  }
  ...
  */
  public static Object wrap(Object value, Class type) {
    ...
    if (type.isPrimitive()) return new Primitive(value);
    return value;
  }
  ...
  */
  public static Primitive getDefaultValue(Class type) {
    ...
    if (type == Boolean.TYPE) return new Primitive(false);
  ...
  */
  public Primitive castToType(Class toType, int operation) throws UtilEvalError {
    return castPrimitive(toType, getType()/**
fromType
*/
    , this/**
fromValue
  ...
  */
  static Primitive castPrimitive(Class toType, Class fromType, Primitive fromValue, boolean checkOnly, int operation) throws UtilEvalError {
    ...
    */
    ...
    if (fromType != null && !fromType.isPrimitive()) throw new InterpreterError("bad fromType:" + fromType);
    ...
    if (fromType == Void.TYPE) if (checkOnly) return Types.INVALID_CAST; else throw Types.castError(Reflect.normalizeClassName(toType), "void value", operation);
    ...
    if (toType.isPrimitive()) {
      ...
      if (fromType == null) if (checkOnly) return Types.INVALID_CAST; else throw Types.castError("primitive type:" + toType, "Null value", operation);
    } else {
      ...
      if (checkOnly) return Types.INVALID_CAST; else throw Types.castError("object type:" + toType, "primitive value", operation);
    }
    // can only cast boolean to boolean
    if (fromType == Boolean.TYPE) {
      if (toType != Boolean.TYPE) if (checkOnly) return Types.INVALID_CAST; else throw Types.castError(toType, fromType, operation);
    ...
    if (operation == Types.ASSIGNMENT && !Types.isJavaAssignable(toType, fromType)) {
      if (checkOnly) return Types.INVALID_CAST; else throw Types.castError(toType, fromType, operation);
    }
  ...
  */
  static Object castWrapper(Class toType, Object value) {
    ...
    if (value instanceof Boolean) {
      if (toType != Boolean.TYPE) throw new InterpreterError("bad wrapper cast of boolean"); else return value;
    }
