...
public class ClassManagerImpl extends BshClassManager
{
  ...
  public static final Pattern pkgPkgPtrn 
 = Pattern.compile("^([a-z0-9.]+)\\.\\1\\.([^.]+)$");
  /**
  ...
  */
  public BshClassPath baseClassPath;
  ...
  /**
    ...
    in that order.
  */
  public BshClassPath fullClassPath;

  // ClassPath Change listeners
  public Vector listeners = new Vector();
  public ReferenceQueue refQueue = new ReferenceQueue();
...
/*
// [DEBUG] trying to resolve variable: Method
// [DEBUG] trying class: Method
// [DEBUG] absoluteNonClass list hit:
  java.lang.reflect.java.lang.reflect.Method
// [DEBUG] absoluteNonClass list hit: 
  java.lang.reflect.java.lang.reflect.Method
// [DEBUG] getClass(): 
  java.lang.reflect.java.lang.reflect.Method 
    not found in BshBinding: global (bsh.BshBinding@96776d00)
// [DEBUG] trying class:
  java.lang.reflect.java.lang.reflect.Method
// [DEBUG] absoluteNonClass list hit: java.lang.reflect.java
// [DEBUG] absoluteNonClass list hit: java.util.java
// [DEBUG] absoluteNonClass list hit: bsh.java
// [DEBUG] absoluteNonClass list hit: libcore.reflect.java
// [DEBUG] absoluteNonClass list hit: java.net.java
// [DEBUG] absoluteNonClass list hit: java.util.zip.java
// [DEBUG] absoluteNonClass list hit: java.util.jar.java
// [DEBUG] absoluteNonClass list hit: brut.directory.java
// [DEBUG] absoluteNonClass list hit: java.util.regex.java
// [DEBUG] absoluteNonClass list hit: org.benf.cfr.reader.util.getopt.java
// [DEBUG] absoluteNonClass list hit: dalvik.system.java
// [DEBUG] absoluteNonClass list hit: java.io.java
// [DEBUG] absoluteNonClass list hit: javax.swing.java
// [DEBUG] absoluteNonClass list hit: javax.swing.border.java
// [DEBUG] absoluteNonClass list hit: org.apache.commons.io.java
// [DEBUG] absoluteNonClass list hit: org.d6r.java
// [DEBUG] absoluteNonClass list hit: org.d6r.util.java
// [DEBUG] absoluteNonClass list hit: bsh.classpath.java
// [DEBUG] absoluteNonClass list hit: java.lang.java
// [DEBUG] absoluteNonClass list hit: javax.swing.event.java
// [DEBUG] absoluteNonClass list hit: java
// [DEBUG] getClass(): java not found in BshBinding: global (bsh.BshBinding@96776d00)
// [DEBUG] absoluteNonClass list hit: java.lang
*/

  public static String fixClassName(String name) { 
    if (Interpreter.PROFILE) System.err.printf(
      "ClassManagerImpl: fixClassName(name = \"%s\")\n",
      name
    );
    
    Matcher matcher = pkgPkgPtrn.matcher(name); 
    if (!matcher.find()) {
      return name;
    } 
    return name.substring(matcher.end(1) + 1);
  }
  ...
  */
  ...
  public Class classForName( String name )
  {
    ...
    if ((Character.isUpperCase(name.charAt(0))
     || name.indexOf('.') != -1)
    &&  bsh.Capabilities.classExists(name)) 
    {
      try {
        c = Class.forName(
          name, false, Thread.currentThread().getContextClassLoader()
        );
        if (c != null) cacheClassInfo( name, c );    
        absoluteNonClasses.add(name);
        return c;
      } catch (ClassNotFoundException exc) {
        throw Reflector.Util.sneakyThrow(exc);
      }
    }
    absoluteNonClasses.add(name);
    return c;
    ...
    if ((c == null) && name.startsWith(BSH_PACKAGE)) {
      ...
      // is null if located in bootclasspath
    ...
    if ( c == null ) {
      try {
        ...
        if ( contextClassLoader != null ) {
          c = Class.forName( name, false, contextClassLoader );
        }
      } catch ( ClassNotFoundException e ) { 
        // fall through
      } catch ( NoClassDefFoundError e ) { 
...
//
  ...
  */
  ...
  @Override
  public boolean hasSuperImport() { return superImport; }
  ...
  */
  ...
  {
    if (Interpreter.PROFILE) System.err.printf(
      "%s: getClassNameByUnqName(name = \"%s\")\n",
      getClass().getSimpleName(), name
    );
