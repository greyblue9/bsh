...
public interface ConsoleOperations {
   ...
   */
  final short MOVE_TO_BEG = 122; //-1;
  
  /**
   *  Operation that moves to the end of the buffer.
   */
  final short MOVE_TO_END = 123; //-3;
...
// 112
   ...
   *  Operation that
   */
  final short NEXT_SPACE_WORD = -22;
   ...
   */
  final static short CLEAR_LINE = -6;

  /**
   * Operation that aborts the current command (like searching)
   */
  final static short ABORT = -32; //-64;
