...
public class Ansi {
  ...
  */
  @NotImplemented(
    target = Ansi.class,
    params = { String.class, Object[].class },
    method = "render(final String text, Object... args)",
    value = "Not applicable after AnsiToHtmlOutputStream refactor"
  )
  public Ansi render(final String text, Object... args) {
    throw new NotImplementedException(
      "Ansi Ansi.render(final String text, Object... args)"
    );
  }
