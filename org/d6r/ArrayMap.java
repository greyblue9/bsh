...
public class ArrayMap<K, V> implements Map<K, V> {
  ...
  public static class Log {
    ...
    public static <T> void d(String fmt, T o, Object... args)
    {
      Object[] all = new Object[args.length + 1];
      all[0] = o;
      System.arraycopy(args, 0, all, 1, args.length);
      System.err.printf(TAG.concat(":").concat(fmt), all);
    }

    public static <T> void w(String fmt, T o, Object... args)
    {
      Object[] all = new Object[args.length + 1];
      all[0] = o;
      System.arraycopy(args, 0, all, 1, args.length);
  ...
  public Class<?> keyClass = Object.class;
  public Class<?> valueClass = Object.class;
  ...
  public static 
  Class<?> typeof(Object o, Class<?> _default) {
  ...
  public ArrayMap(Iterable<? super Entry<K,V>> entrySet) {
    this();
    
    Iterator<?> _it = entrySet.iterator();
    if (! _it.hasNext()) return;
    
    Object o1 = _it.next();
    if (o1 instanceof Pair<?,?>) {
      Iterator<Pair<K, V>> it = (Iterator<Pair<K, V>>) _it;
      Pair<K,V> p1 = (Pair<K,V>) o1;
      
      put(p1.getKey(), p1.getValue());
      keyClass = typeof(p1.getKey(), keyClass);
      valueClass = typeof(p1.getKey(), valueClass);
    ...
    if (o1 instanceof Entry<?,?>) {
      Iterator<Entry<K, V>> it = (Iterator<Entry<K, V>>) _it;
      Entry<K,V> e1 = (Pair<K,V>) o1;
      
      put(e1.getKey(), e1.getValue());
      keyClass = typeof(e1.getKey(), keyClass);
      valueClass = typeof(e1.getKey(), valueClass);
...
abstract class MapCollections<K, V> {
  ...
  final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
    ...
    public final boolean equals(Object o) {
      ...
      return UtilObjects.equal(e.getKey(), colGetEntry(mIndex, 0)) && UtilObjects.equal(e.getValue(), colGetEntry(mIndex, 1));
    }
  ...
  final class EntrySet implements Set<Map.Entry<K, V>> {
    ...
    public boolean contains(Object o) {
      ...
      return UtilObjects.equal(foundVal, e.getValue());
    }
...
class EmptyArray {
  ...
  public static <E> E[] of(Object o) {
    Class<E> cls = null;
    if (o instanceof Class) {
      cls = (Class<E>) (Object) o;
    } else if (o == null) {
      return (E[]) (Object) new Object[0];
    } else if (o.getClass().getName().equals("bsh.ClassIdentifier")) {
      try {
        cls = (Class<E>) (Object) o.getClass().getDeclaredMethod("getTargetClass").invoke(o);
      } catch (Throwable e) {
      }
    }
    if (cls == null) {
      cls = (Class<E>) (Object) o.getClass();
    }
    return (E[]) Array.newInstance(cls, 0);
  }
}
