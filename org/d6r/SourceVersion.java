...
/**
  ...
  See the appropriate edition of The Java Language
  Specification for information about a particular source
  version.
  
  Note that additional source version constants will be
  added to model future releases of the language.
...
public enum SourceVersion {
  ...
  */
  RELEASE_0,     /**
    ...
    as
    described in the 1.1 update to
    <cite>The Java&trade; Language Specification, First Edition</cite>.
  */
  RELEASE_1,     /**
...
default
  ...
  */
  ...
  private static SourceVersion getLatestSupported() {
    try {
      ...
      switch((specVersion)) {
        case "1.9": return RELEASE_9;
        case "1.8": return RELEASE_8;
        case "1.7": return RELEASE_7;
        case "1.6": return RELEASE_6;
        case "1.5": return RELEASE_6;
        case "1.4": return RELEASE_4;
        case "1.3": return RELEASE_3;
        case "1.2": return RELEASE_2;
        case "1.1": return RELEASE_1;        
      }
  ...
  /**
    ...
    current execution environment.  {@code RELEASE_5} or later
    must
    be returned.
  ...
  */
  ...
  /**
    ...
    valid identifier (simple name) or keyword in the latest 
    source version.  The method returns {@code true} if the 
    name consists of an initial character for which 
    {@link Character#isJavaIdentifierStart(int)} returns
    {@code true},
    
    followed only by characters for which
    {@link Character#isJavaIdentifierPart(int)} returns
    {@code true}.
    
    This pattern matches regular identifiers, keywords, and 
    the literals {@code "true"}, {@code "false"}, and
    {@code "null"}.
  ...
  */
  ...
  /**
    Returns whether or not {@code name} is a syntactically 
    valid qualified name in the latest source version.
    Unlike {@link #isIdentifier isIdentifier}, this method
    returns {@code false} for keywords and literals.
   
    @param name the string to check
    @return {@code true} if this string is a syntactically 
  ...
  */
  public static boolean isName(CharSequence name) {
    ...
    for (String s : id.split("\\.", -1)) {
      if (!isIdentifier(s) || isKeyword(s)) return false;
    }
    return true;
  }
  ...
  static {
    ...
    for (String kw : kws) s.add(kw);
    keywords = Collections.unmodifiableSet(s);
  }
  
  /**
    Returns whether or not {@code s} is a keyword or literal
    in the latest source version.
   
    @param s the string to check
    @return {@code true} if {@code s} is a keyword or
