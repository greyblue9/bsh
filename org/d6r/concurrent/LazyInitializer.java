...
class ThrowHelper {
  ...
  X sneakyThrow(Throwable t) { 
    return (X) ThrowHelper.<Error>sneakyThrow2(t);
  }
  
  @SuppressWarnings("unchecked") private static <T extends Throwable> 
  Throwable sneakyThrow2(Throwable t) throws T {
    if (t == null) {
      t = new RuntimeException("sneakyThrow2: t == null!");
           ...
           implements ConcurrentInitializer<T> 
{
     ...
     * On first access the object
     * is created. 
     * After that it is cached and can be accessed pretty fast.
     *
     * @return the object initialized by this {@code LazyInitializer}
     * @throws ConcurrentException if an error occurred during
     * initialization of
     * the object
     */
    @Override
    public T get() {
        // use a temporary variable to reduce the number of 
        // reads of the volatile field
        T result = object;
            ...
            synchronized (this) {
                ...
                if (result == null) {
                  try {
                    ...
                    throw ThrowHelper.sneakyThrow(e);
                  }
                }
            }
        }
     ...
     * LazyInitializer}. This method is called by {@link #get()} 
     * when the object
     * is accessed for the first time. 
     * An implementation can focus on the
     * creation of the object. 
     * No synchronization is needed, as this is already
     * handled by {@code get()}.
     *
     * @return the managed data object
     * @throws Throwable if an error occurs during 
     * object creation
     */
