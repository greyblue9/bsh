...
public class dumpMembers2 {
 ...
 = new HashSet<Type>();
  ...
  Object o) 
  {
    ...
    env.println(dumpMembers2(obj, cls, verbose));
  }
  
  public static void invoke(Interpreter env, CallStack callstack, 
  Object o, Class<?> cls) {
    
    env.println(dumpMembers2(o, cls, verbose));
  }
  ...
  public static String dumpMembers2
  (Object o, Class<?> cls, boolean verbose) {
  
    DumpMemberOptions opts 
 = new DumpMemberOptions();
    opts.verbose = verbose;
    return dumpMembers2(o, cls, opts);
  }
 ...
 = cls.getGenericSuperclass();
    ...
    for (int icIdx=0; icIdx<innerClasses.length; icIdx++) 
    {
      ...
      try {
        innerDump = dumpMembers2(o, innerCls, verbose);
      } catch (Throwable e) { 
        innerDump = dumpMembers2(o, innerCls, verbose);
      }
    ...
    for (Object extended: extendsArr)
    {
      ...
      sb.append(lf);
      sb.append( dumpMembers2(o, iCls, options) );
    }
    ...
    if (superCls != null && superCls != Object.class
     && ! options.visited.contains(superCls)) {
      ...
      sb.append((char)0x0A);
      sb.append(
        dumpMembers2(o, superCls, options)
      );
    }
    //sb.append(lf);
    return sb.toString();
